  ...
  after:absolute after:rounded-[inherit] after:pointer-events-none after:border-t after:inset-0 shadow`,
  {
    variants: {
      variant: {
        ...
        inner: 'before:border-[hsl(0deg,0%,85%)] after:border-t-black/30 after:shadow-[0px_5px_15px_rgba(0,0,0,0.35)_inset]'
      },
      elevation: {
      ...
      lightDirection: {
        ...
        topLeft: 'before:border-r after:border-l drop-shadow-[4px_4px_2px_rgba(0,0,0,0.15)]',
        topRight: 'before:border-l after:border-r drop-shadow-[-4px_4px_2px_rgba(0,0,0,0.15)]'
      },
      opacity: {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        className: 'before:bg-[linear-gradient(135deg,rgba(255,255,255,0.15)_15%,rgba(0,0,0,0.25)_80%)]'
      },
      {
        light: 'linear',
        lightDirection: 'topRight',
        className: 'before:bg-[linear-gradient(225deg,rgba(255,255,255,0.15)_15%,rgba(0,0,0,0.25)_80%)]'
      },
      {
        light: 'radial',
        lightDirection: 'topLeft',
        className: 'before:bg-[radial-gradient(ellipse_at_0%_-150%,_var(--tw-gradient-stops))]'
      },
      {
        light: 'radial',
        lightDirection: 'topRight',
        className: 'before:bg-[radial-gradient(ellipse_at_100%_-150%,_var(--tw-gradient-stops))]'
      }
    ],
    defaultVariants: {
      round: 'full',
...
export function DepthLayerTailwind({ variant, children, round, elevation, hoverable, lightDirection, light, opacity, clickable, ...args }: DepthLayerProps) {
  return (
    <span
