...
export type DepthLayerProps = PropsWithChildren &
  VariantProps<typeof depthLayerStyles> &
...
export function DepthLayer({
  ...
  const childElement =
    document.getElementById("depth-decorator")?.firstElementChild;

  if (childElement) {
    const radius = window.getComputedStyle(childElement).borderRadius;
    document.getElementById("depth-decorator")!.style.borderRadius = radius;
  }
